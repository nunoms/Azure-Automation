# installs the web-app-staging-slot-continuous-deployment template
...
$baseUrl = "https://raw.githubusercontent.com/nunoms/Azure-Automation/master/ARM/web-app-staging-slot-continuous-deployment"
